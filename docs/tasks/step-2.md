...
Stlye the homepage. Play with colors, fonts, layout etc. In `src/pages/index.vue` add classes to the sections and define the styles using css in the `<style> ... </stlye>` section.
